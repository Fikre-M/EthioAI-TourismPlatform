  ...
  const mockTours: Tour[] = [
    ...
    },
    {
      ...
      startLocation: {
        ...
        coordinates: [14.2419, 40.3026],
        address: 'Danakil Depression, Afar Region',
      },
      locations: [
        {
          name: 'Erta Ale Volcano',
          coordinates: [13.6000, 40.6667],
          description: 'Active volcano with lava lake',
        },
      ],
      language: 'English',
    ...
    },
    {
      ...
      startLocation: {
        name: 'Jinka',
        coordinates: [5.7804, 36.5700],
        address: 'Jinka, Southern Nations Region',
      },
      locations: [
        {
          name: 'Mursi Village',
          coordinates: [5.7500, 36.6000],
          description: 'Home of the Mursi people',
        },
      ],
      language: 'English',
    ...
    },
    {
      ...
      startLocation: {
        ...
        coordinates: [6.8333, 39.7500],
        address: 'Bale Mountains, Oromia Region',
      },
      locations: [
        {
          name: 'Sanetti Plateau',
          coordinates: [6.9000, 39.8000],
          description: 'Highest plateau in Ethiopia',
        },
      ],
      language: 'English',
    ...
    },
    {
      ...
      slug: 'tigray-rock-churches-exploration',
      ...
      startLocation: {
        ...
        address: 'Mekele, Tigray Region',
      },
      locations: [
        {
          name: 'Abuna Yemata Guh',
          coordinates: [13.5333, 39.4167],
          description: 'Iconic cliff church',
        },
      ],
      language: 'English',
