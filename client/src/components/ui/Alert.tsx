...
export const Alert = ({
  ...
  const variants = {
    ...
    outline: {
      container: 'border border-gray-300 text-gray-800 dark:border-gray-600 dark:text-gray-200',
      icon: 'text-gray-400',
    },
  }
  ...
  return (
    <div
      className={`rounded-lg border p-4 ${currentVariant.container} ${className}`}
      role="alert"
      {...props}
    >
      <div className="flex">
        ...
        {closable && onClose && (
          <div className="ml-auto pl-3">
            <button
              type="button"
              className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${currentVariant.icon} hover:opacity-75`}
              onClick={onClose}
