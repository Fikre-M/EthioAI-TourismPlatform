    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 sm:mb-8">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Car Rental</h1>
            <p className="text-sm sm:text-base text-gray-600">Rent a car for your Ethiopian adventure</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="sm:col-span-2 flex items-end">
              <Button
                ...
                className="w-full bg-green-600 hover:bg-green-700 text-white py-3 text-sm sm:text-base"
              >
                {isSearching ? (
                  <>
        ...
        {/* Popular Locations */}
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Popular Pickup Locations</h2>
