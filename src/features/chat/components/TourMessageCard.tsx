import { TourMessage } from '@/types/richMessage'

export interface TourMessageCardProps {
  message: TourMessage
}

export const TourMessageCard = ({ message }: TourMessageCardProps) => {
  const { tour } = message
      ...
      <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:shadow-lg transition-shadow">
        ...
        <div className="p-4">
          ...
          {tour.highlights.length > 0 && (
            <div className="mb-3">
              <p className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Highlights:</p>
