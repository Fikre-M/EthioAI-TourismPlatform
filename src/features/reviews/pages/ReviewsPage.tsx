...
import {
  FaStar, FaFilter, FaSort, FaSearch, FaPlus, FaImage,
  FaVideo, FaThumbsUp, FaComment, FaShare, FaFlag,
  FaMapMarkerAlt, FaCalendar, FaUser, FaCheckCircle,
  FaHeart, FaEye, FaTrophy, FaFire, FaGlobe
} from 'react-icons/fa'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            ...
            <div className="bg-white rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-gray-900">{stats.withMedia}</div>
              <div className="text-sm text-gray-600">With Photos/Videos</div>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
