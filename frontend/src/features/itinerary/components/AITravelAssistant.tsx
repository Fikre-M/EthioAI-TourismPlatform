...
import {
  FaRobot, FaMicrophone, FaPaperPlane, FaTimes, FaLightbulb,
  FaMapMarkerAlt, FaDollarSign, FaWeatherSun, FaExclamationTriangle,
  FaClock, FaThumbsUp, FaThumbsDown, FaBookmark, FaShare
} from 'react-icons/fa'
